    ...
    TopAppBar(
        ...
        navigationIcon = {
            if (state.canGoBack) {
                ...
                val (icon, description) = when (config.closeIconStyle) {
                    CloseIconStyle.ArrowBack -> Icons.AutoMirrored.Filled.ArrowBack to "返回"
                    CloseIconStyle.Close -> Icons.Filled.Close to "关闭"
                }
